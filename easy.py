...
def actualizar_texto(turno_jugador, texto_anterior=None):
    ...
    # Determinar el nuevo texto según el turno
    fuente = pygame.font.SysFont(None, 24)
    ...
    # No actualizar si el texto es el mismo que el anterior
    if texto3 == texto_anterior:
        return texto_anterior  # Salir de la función si el texto no ha cambiado
    ...
    return texto3  # Retornar el nuevo texto para futuras comparaciones
